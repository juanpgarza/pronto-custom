...
class AccountMove(models.Model):
    ...
    def button_draft(self):
        ...
        for rec in self:
            if rec.move_type in ('out_invoice','out_refund') and rec.journal_id.l10n_latam_use_documents and not self.env.user.has_group('pronto_account.group_cancelar_comprobante_fiscal'):                
